...
from src.low_level_operations import ends_in
...
def get_batch_kwargs(context, dataset_path: os.path) -> dict:
    ...
    reader_method = "read_csv" if ends_in(".csv", dataset_path) else "read_excel"
    return {
...
def get_batch_expectation_function(batch, function_name: str) -> dict:
    """
